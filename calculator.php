            ...
            <form action="/action_page.php">
                ...
                <div class = "row">
                    ...
                    <div class = "col-25">
                        ...
                        <input type="number" id="scen1BruSalary" name="scen1BruSalary" min = 0 placeholder="Skriv lägre lön" oninput="calculateNettoSalary()">
                        </div>
